...
# 教程来源:https://segmentfault.com/a/1190000018597501
# 设置程序不可见运行
...
# 导入已存的demo表格
load_wb = app.books.open('test2.xlsx')
# # 打开活动的工作薄的活动工作簿，或者指定的工作簿
# load_ws = load_wb.sheets.active
load_ws = load_wb.sheets['Sheet2']
...
# 1-①在第二行前插入2行(可理解为: 在第2-3行插入空白行)
# load_ws.api.rows('2:3').insert
# 1-②删除第2-3行
# load_ws.api.rows('2:3').delete
